    ...
    <section className="container mx-auto my-4 max-w-5xl p-4">
      ...
      <div className="mx-auto mt-20 max-w-lg">
        <div className="relative w-full rounded-lg bg-blue-100 p-4 ps-20 md:h-64 md:ps-48">
            ...
            <table className="mt-4 w-full text-sm">
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a
                      href="mailto:dev.mourao@gmail.com"
                      className="underline hover:text-blue-800"
                    >
                      dev.mourao@gmail.com
                    </a>
                  </td>
                </tr>
                <tr>
          ...
          <div className="absolute -left-2 -top-4 h-24 w-20 rounded-lg bg-gray-600 bg-[url(https://lh3.googleusercontent.com/ogw/AF2bZygUc3OBv7wgJ-S3SNB4v_6YKD_p8XR2KzdSliMdovz8J4o=s32-c-mo)] bg-cover bg-center md:-left-12 md:-top-12 md:h-72 md:w-56"></div>
        </div>
      </div>
    </section>
  )
