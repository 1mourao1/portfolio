      ...
      <section className="rounded-br-[80px] bg-gradient-to-tr from-black to-gray-900 text-white md:rounded-br-[180px]">
        <div className="container mx-auto flex max-w-4xl flex-col-reverse p-4 py-12 md:flex-row">
          <div className="basis-1/2">
            ...
            Sou um desenvolvedor full stack com grande entusiasmo por criar experiências web inovadoras. Atualmente, atuo como freelancer, dedicando-me a transformar conceitos em sites e aplicações web funcionais e intuitivas.
            </p>
