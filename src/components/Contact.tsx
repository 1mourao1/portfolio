...
export default function Contact() {
  ...
  const contacts = [
    {
      name: "WhatsApp",
      description: "+55 99 99187-4221",
      link: "https://wa.me/5599991874221?text=Olá...",
      icon: <FaWhatsapp className="h-10 w-10" />,
    },
    {
      name: "Email",
      description: "dev.mourao@gmail.com",
      link: "mailto:dev.mourao@gmail.com?subject=Olá...",
      icon: <HiOutlineEnvelope className="h-10 w-10" />,
    },
    {
      name: "Açailândia, MA",
      description: "Vila Ildemar",
      link: "https://maps.app.goo.gl/UCNnhVQqqFA9Arzy7",
